...
def testModel_clip(model,opt):
    ...
    with torch.no_grad():
        for i,sample in enumerate(testDataset):
            ...
            pt.write('{}, {:.4f}, {:.4f}, {:.4f}, {}\n'.format(file_id, bceLoss, bceLoss_v1, diceLoss, int(label.sum().item())))
